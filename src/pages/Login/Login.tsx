                ...
                <div className="w-full p-5">
                    <form action="#" className="flex flex-col space-y-5">
                        ...
                        <div>
                            <button
                                type="submit"
                                className="text-sm w-full px-4 py-2 font-semibold text-white transition-colors duration-300 bg-blue-500 rounded-md shadow hover:bg-blue-600 focus:outline-none focus:ring-blue-200 focus:ring-4"
                            >
                                Log in
                            </button>
                        </div>
                        ...
                        <p className="text-sm font-light text-white">
                                Don't have an account? <a href="/signup"
                                    className="font-medium text-blue-300">Create an
                                    Account</a>
                            </p>
                    </form>
                </div>
